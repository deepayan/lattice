...
## original panel.bwplot.  Superceded by new version below that
## supports notches, but keeping around for a while just in case
## (2008/11/20)
...
## modified version that supports notches (based on patch from Mike Kay)
